...
- !MUST be transparent, and pass input through (except when an Ad is showing)
...
- !MUST ONLY start playing as a result of the user clicking a clearly marked "play"
button associated with the video content
