...
swarm_teams       | game_info   |  A JSON object with the teams formation        |   See [notes](#swarm_teams-note)                  |   70.0        |
...
teams is deprecated and will be replaced by swarm_teams - See [notes](#swarm_teams-note)
